...
import com.ecomerce.ecommerce.exceptions.AuthenticationFileException;
import com.ecomerce.ecommerce.exceptions.CustomException;
...
public class UserService {
    ...
    public SignInResponseDto signIn(SignInDto signInDto) {
        ...
        if (Objects.isNull(user)) {
            throw new AuthenticationFileException("user is not valid");
        }
        ...
        try {
            if (!user.getPassword().equals(hashPassword(signInDto.getPassword()))) {
                throw new AuthenticationFileException("wrong password");
            }
        } catch (NoSuchAlgorithmException e) {
            e.printStackTrace();
        }
